...
export default function Footer() {
    ...
    return (
        <section
            ref={sectionRef}
            className="relative w-full min-h-screen mt-16 footershade bg-cover bg-center bg-no-repeat text-white flex flex-col justify-center items-center px-5 sm:px-8">
            ...
            >
                ...
                <div className="max-w-[90%] sm:max-w-[70%] text-center pt-42">
                    <div className="flex items-center justify-center gap-5 my-6">
                        ...
                        <span className="text-[14px] italic tracking-wider" style={{ wordSpacing: "3px" }}>
                            Available to work
                        </span>
                        <div className="h-[1px] w-16 sm:w-28 bg-[#898989] opacity-40"></div>
                    </div>
                ...
                <div className="mt-10">
                    <motion.button
                        ...
                        className="flex items-center gap-4 bg-black text-white px-5 py-3 rounded-full shadow-lg hover:opacity-100 active:scale-95 transition-opacity duration-300"
                    >
