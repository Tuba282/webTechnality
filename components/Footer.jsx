...
import { BsFillArrowUpCircleFill, BsFillArrowUpRightSquareFill } from "react-icons/bs";
...
export default function Footer({ is_margin = true }) {
    ...
    return (
        ...
        >
                ...
                <div className="mt-10">
                    ...
                    >
                        <img
                            src="/favicon.png"
                            alt="Logo"
                            className="drop-shadow-sm drop-shadow-white w-8 h-8 sm:w-10 sm:h-10 drop-shadow-md p-1"
                        />
                        Book a Meeting
            ...
            {/* Footer */}
            <footer className="w-full mt-24 mb-8 flex flex-col md:flex-row justify-between items-center gap-5 sm:gap-8 px-4 sm:px-6 text-[#898989] relative">
                <div className="flex flex-col md:flex-row gap-4 items-center text-sm">
                    <span className="py-2 px-1 border-t border-b border-white text-white">
                        © WebTechnality, 2025
                    </span>
                ...
                <motion.button
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1, delay: 0.7 }}
                    className="cursor-target absolute right-0 -top-15 bg-[#D3D3D3] text-gray-700 p-3 rounded-full shadow-lg active:scale-95 transition"
                >
